...
function CreateToDoItems() {
    if (todoValue.value === "") {
      ...
      const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                      <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="edit icon.png" />
                      <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="delete icn.png" /></div></div>`;
